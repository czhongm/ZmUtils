package net.childman.libmvvm.widget.ahbottomnavigation;
...
import net.childman.libmvvm.widget.ahbottomnavigation.notification.AHNotification;
import net.childman.libmvvm.widget.ahbottomnavigation.notification.AHNotificationHelper;
...
public class AHBottomNavigation extends FrameLayout {
    ...
    private void updateNotifications(boolean updateStyle, int itemPosition) {
        ...
        for (int i = 0; i < views.size(); i++) {
            ...
            final ImageView redDot = views.get(i).findViewById(R.id.red_dot);
            ...
            if (notificationItem.isEmpty() && notification.getText().length() > 0) {
                ...
                if ("-1".equals(notificationItem.getText())) {
